...
CREATE TABLE User (
    ...
    CreditCardExpirationNameDate	VARCHAR(50),
...
CREATE TABLE Invoice (
	...
	UserID			INT NOT NULL,
	InvoiceDate		DATETIME NOT NULL DEFAULT '1990-00-00 00:00:00',
...
INSERT INTO Product VALUES 
	('1', '8601', '86 (the band) - True Life SOngs', '14.95'),
	('2', 'pf01', 'Paddlefoot - The First CD', '12.95'),
	('3', 'pf02', 'Paddlefoot - The second CD', '14.95'),
	('4', 'jr01', 'Joe Rut - Genuine Wood', '14.95');
